...
public class SnakeView extends View {
	...
	Runnable moveRunnable=new Runnable() {
		...
		public void run() {
			// TODO Auto-generated method stub
			if(SnakeView.this.getStatue() != SnakeView.this.RUNNING)
			{
